 ...
 *     hide_user_not_found?: bool, // Default: true
 ...
 *                     base_uri: scalar|null, // Base URI of the userinfo endpoint on the OIDC server.
 ...
 *                     keyset: scalar|null, // JSON-encoded JWKSet used to sign the token (must contain a list of valid keys).
 *                 },
 *                 cas?: array{
 ...
 *                 service?: scalar|null, // The service ID of a custom rememberme token provider.
 *                 doctrine?: bool|array{
 *                     enabled?: bool, // Default: false
 ...
 *     cache?: scalar|null, // Default: "%kernel.cache_dir%/twig"
